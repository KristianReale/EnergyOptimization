...
def calculate_best_storage():
    ...
    for match in matches_vOVER_I:
        ...
        vOVER_I_results.append({"day": valori[0], "time": valori[1], "value": valori[2]})
    ...
    for match in matches_vUNDER_I:
        ...
        # Creare un oggetto VP_PV con i valori estratti
        vUNDER_I_results.append({"day": valori[0], "time": valori[1], "value": valori[2]})


    # To be calculated iteratively
    vSOC_I = []

    object_result = {"OVER": vOVER_I_results, "UNDER": vUNDER_I_results}
