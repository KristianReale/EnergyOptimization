...
do    
	...
	date="${date%.*}"
        ...
        #echo "clingo ../../encoding_article.asp params_from_python.asp maxChargeKwh.asp ${factsFile} ${initChargeFile} $1 --parallel-mode=8 --time-limit=1200 --quiet=1 --outf=1 > Results/${house}/output_${house}_${date}.txt"
        clingo ../../encoding_article.asp params_from_python.asp maxChargeKwh.asp "${factsFile}" "${initChargeFile}" $1 --parallel-mode=8 --time-limit=1200 --quiet=1 --outf=1 > "Results/${house}/output_${house}_${date}.txt"
