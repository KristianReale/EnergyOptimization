...
class TestExecution(unittest.TestCase):
    def test_execution(self):
        build_from_csv("DatasetDati/H1_Wh.csv", "InputDataset/H1_Wh",split_data=SPLIT_DATA.DAY, format=FORMAT.ASP, unit="KW")
        build_from_csv("DatasetDati/H1_Wh.csv", "InputDataset/H1_Wh",split_data=SPLIT_DATA.DAY, format=FORMAT.CSV, unit="KW")
